...
if ( ! function_exists( 'wpbstarter_setup' ) ) :
	...
	function wpbstarter_setup() {
		...
		// add_image_size( 'wpbstarter-logo', 300, 90, false );
...
function wpbstarter_widgets_init() {
    ...
    register_sidebar( array(
        'name'          => esc_html__( 'Footer 4', 'wpbstarter' ),
        'id'            => 'footer-4',
        'description'   => esc_html__( 'Add widgets here.', 'wpbstarter' ),
        'before_widget' => '<section id="%1$s" class="widget %2$s">',
        'after_widget'  => '</section>',
    ...
    register_sidebar( array(
        'name'          => esc_html__( 'Topbar Header', 'wpbstarter' ),
        'id'            => 'topbar-1',
        'description'   => esc_html__( 'Add widgets here.', 'wpbstarter' ),
        'before_widget' => '<section id="%1$s" class="topbarwidget %2$s">',
        'after_widget'  => '</section>'
    ) );
}
